...
function MyPage({ isLogin, userInfo, setUserInfo }) {
  ...
  function nickNameDuplicated(e){
    ...
    axios.post('https://takecareofmycloset/duplicate', nickName, 
  ...
  <section>
    ...
    <fieldset>
      ...
      <section>
        ...
        <input type="text" placeholder="닉네임을 입력해주세요" onChange={(e) => {nickNameChange(e)}}/>
        <span className={nickNameClassNameOn}>중복된 닉네임입니다. 다른 닉네임을 입력해주세요.</span>
        <button onClick={(e) =>{nickNameDuplicated(e)}}>중복확인</button>
      </section>
